...
namespace FishNet.Managing.Transporting
{
    ...
    public sealed partial class TransportManager : MonoBehaviour
    {
        ...
        public Transport TugboatTransport;
        ...
        internal void InitializeOnceInternal(NetworkManager manager)
        {
            ...
            if (SteamEnabled)
            {
                TugboatTransport.gameObject.SetActive(false);
                SteamTransport.gameObject.SetActive(true);
                Transport = SteamTransport;
            }
            else
            {
                TugboatTransport.gameObject.SetActive(true);
                SteamTransport.gameObject.SetActive(false);
                Transport = TugboatTransport;
            }
